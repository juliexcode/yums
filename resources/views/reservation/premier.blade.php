...
<div class="container">
    ...
    <form method="POST" action="{{route ('reservation.store.premier')}}">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nom" class="form-control" value="{{$resa->nom ?? ''}}" placeholder="Votre nom">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="personnes" min="1" max="10" class="form-control" value="{{$resa->personnes ?? ''}}">
